...
from src.storage.models import MatchStatus
from src.storage.repositories.submission import (
    check_solution,
    fetch_test_cases,
    get_match_by_id,
    get_problem_by_id,
        ...
        try:
            ...
            if is_correct:
                ...
                if not winner or not loser:
                    submission_logger.error("Could not load player storage")
                    raise ResourceNotFoundException(
                        detail="Could not load player storage"
                    )
