...
from src.handler.schemas.problem import ProblemUpdate
from src.storage.repositories import get_session
from src.storage.repositories.problem import (
...
@problem_router.delete(
    ...
    description="Deletes a problem and its associated storage from DigitalOcean Spaces.",
)
async def delete_problem(
    problem_id: UUID4,
    db: AsyncSession = Depends(get_session),
):
    """Delete a problem and its associated storage."""
...
async def list_problems(
    ...
    TODO: Implement list_problems_from_db in src/storage/repositories/problem.py.
    """
