...
class Settings(BaseSettings):
    ...
    MATCH_ACCEPT_TIMEOUT_SECONDS: int = Field(60, env="MATCH_ACCEPT_TIMEOUT_SECONDS")
...
# NOTE: Use Config.MATCH_ACCEPT_TIMEOUT_SECONDS and Config.MATCH_DURATION_SECONDS
